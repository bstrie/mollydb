...
select armor('zooka', array['Version', 'Comment'], array['Created by pgcrypto', 'MollyDB, the world''s most advanced open source database']);
select * from pgp_armor_headers(
  armor('zooka', array['Version', 'Comment'],
                 array['Created by pgcrypto', 'MollyDB, the world''s most advanced open source database']));
