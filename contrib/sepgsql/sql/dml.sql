...
SECURITY LABEL ON TABLE t1 IS 'system_u:object_r:semdb_table_t:s0';
INSERT INTO t1 VALUES (1, 'aaa'), (2, 'bbb'), (3, 'ccc');

CREATE TABLE t2 (x int, y text);
SECURITY LABEL ON TABLE t2 IS 'system_u:object_r:semdb_ro_table_t:s0';
INSERT INTO t2 VALUES (1, 'xxx'), (2, 'yyy'), (3, 'zzz');

CREATE TABLE t3 (s int, t text);
SECURITY LABEL ON TABLE t3 IS 'system_u:object_r:semdb_fixed_table_t:s0';
INSERT INTO t3 VALUES (1, 'sss'), (2, 'ttt'), (3, 'uuu');

CREATE TABLE t4 (m int, n text);
SECURITY LABEL ON TABLE t4 IS 'system_u:object_r:semdb_secret_table_t:s0';
INSERT INTO t4 VALUES (1, 'mmm'), (2, 'nnn'), (3, 'ooo');

CREATE TABLE t5 (e text, f text, g text);
SECURITY LABEL ON TABLE t5 IS 'system_u:object_r:semdb_table_t:s0';
SECURITY LABEL ON COLUMN t5.e IS 'system_u:object_r:semdb_table_t:s0';
SECURITY LABEL ON COLUMN t5.f IS 'system_u:object_r:semdb_ro_table_t:s0';
SECURITY LABEL ON COLUMN t5.g IS 'system_u:object_r:semdb_secret_table_t:s0';

CREATE TABLE customer (cid int primary key, cname text, ccredit text);
SECURITY LABEL ON COLUMN customer.ccredit IS 'system_u:object_r:semdb_secret_table_t:s0';
