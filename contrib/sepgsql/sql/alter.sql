...
DROP DATABASE IF EXISTS regtest_semdb_test_database_1;
...
--
CREATE DATABASE regtest_semdb_test_database_1;
...
CREATE FUNCTION regtest_func_1 (text) RETURNS bool
  AS 'BEGIN RETURN true; END' LANGUAGE 'plmdb';
...
--
ALTER DATABASE regtest_semdb_test_database_1 OWNER TO regtest_semdb_test_user;
ALTER DATABASE regtest_semdb_test_database_1 OWNER TO regtest_semdb_test_user;
ALTER SCHEMA regtest_schema_1 OWNER TO regtest_semdb_test_user;
ALTER SCHEMA regtest_schema_1 OWNER TO regtest_semdb_test_user;
ALTER TABLE regtest_table_1 OWNER TO regtest_semdb_test_user;
ALTER TABLE regtest_table_1 OWNER TO regtest_semdb_test_user;
ALTER SEQUENCE regtest_seq_1 OWNER TO regtest_semdb_test_user;
ALTER SEQUENCE regtest_seq_1 OWNER TO regtest_semdb_test_user;
ALTER VIEW regtest_view_1 OWNER TO regtest_semdb_test_user;
ALTER VIEW regtest_view_1 OWNER TO regtest_semdb_test_user;
ALTER FUNCTION regtest_func_1(text) OWNER TO regtest_semdb_test_user;
ALTER FUNCTION regtest_func_1(text) OWNER TO regtest_semdb_test_user;
...
-- ALTER xxx RENAME TO
--
ALTER DATABASE regtest_semdb_test_database_1 RENAME TO regtest_semdb_test_database;
...
-- misc ALTER commands
--
ALTER DATABASE regtest_semdb_test_database CONNECTION LIMIT 999;
ALTER DATABASE regtest_semdb_test_database SET search_path TO regtest_schema, public; -- not supported yet
