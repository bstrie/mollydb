...
** Bytea ops
*/
MDB_FUNCTION_INFO_V1(gbt_numeric_compress);
MDB_FUNCTION_INFO_V1(gbt_numeric_union);
MDB_FUNCTION_INFO_V1(gbt_numeric_picksplit);
MDB_FUNCTION_INFO_V1(gbt_numeric_consistent);
MDB_FUNCTION_INFO_V1(gbt_numeric_penalty);
MDB_FUNCTION_INFO_V1(gbt_numeric_same);
...
Datum
gbt_numeric_compress(MDB_FUNCTION_ARGS)
{
...
Datum
gbt_numeric_consistent(MDB_FUNCTION_ARGS)
{
	GISTENTRY  *entry = (GISTENTRY *) MDB_GETARG_POINTER(0);
	void	   *query = (void *) DatumGetNumeric(MDB_GETARG_DATUM(1));
...
Datum
gbt_numeric_union(MDB_FUNCTION_ARGS)
{
...
Datum
gbt_numeric_same(MDB_FUNCTION_ARGS)
{
...
Datum
gbt_numeric_penalty(MDB_FUNCTION_ARGS)
{
	...
	gbt_var_bin_union(&uni, newe, MDB_GET_COLLATION(), &tinfo);
...
Datum
gbt_numeric_picksplit(MDB_FUNCTION_ARGS)
{
	GistEntryVector *entryvec = (GistEntryVector *) MDB_GETARG_POINTER(0);
