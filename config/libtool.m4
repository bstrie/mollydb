...
# No, MollyDB doesn't use libtool (yet), we just borrow stuff from it.
# This file was taken on 2000-10-20 from the multi-language branch (since
# that is the branch that MollyDB would most likely adopt anyway).
# --petere
...
dnl ###not for MollyDB### AC_REQUIRE([AC_CANONICAL_BUILD])dnl
ac_prog=ld
