 ...
 *-------------------------------------------------------------------------
 */
#ifndef _MDB_TSTYPE_H_
#define _MDB_TSTYPE_H_
...
#define DatumGetTSVector(X)			((TSVector) MDB_DETOAST_DATUM(X))
#define DatumGetTSVectorCopy(X)		((TSVector) MDB_DETOAST_DATUM_COPY(X))
#define TSVectorGetDatum(X)			PointerGetDatum(X)
#define MDB_GETARG_TSVECTOR(n)		DatumGetTSVector(MDB_GETARG_DATUM(n))
#define MDB_GETARG_TSVECTOR_COPY(n)	DatumGetTSVectorCopy(MDB_GETARG_DATUM(n))
#define MDB_RETURN_TSVECTOR(x)		return TSVectorGetDatum(x)

/*
 * I/O
 */
extern Datum tsvectorin(MDB_FUNCTION_ARGS);
extern Datum tsvectorout(MDB_FUNCTION_ARGS);
extern Datum tsvectorsend(MDB_FUNCTION_ARGS);
extern Datum tsvectorrecv(MDB_FUNCTION_ARGS);

/*
 * operations with tsvector
 */
extern Datum tsvector_lt(MDB_FUNCTION_ARGS);
extern Datum tsvector_le(MDB_FUNCTION_ARGS);
extern Datum tsvector_eq(MDB_FUNCTION_ARGS);
extern Datum tsvector_ne(MDB_FUNCTION_ARGS);
extern Datum tsvector_ge(MDB_FUNCTION_ARGS);
extern Datum tsvector_gt(MDB_FUNCTION_ARGS);
extern Datum tsvector_cmp(MDB_FUNCTION_ARGS);

extern Datum tsvector_length(MDB_FUNCTION_ARGS);
extern Datum tsvector_strip(MDB_FUNCTION_ARGS);
extern Datum tsvector_setweight(MDB_FUNCTION_ARGS);
extern Datum tsvector_setweight_by_filter(MDB_FUNCTION_ARGS);
extern Datum tsvector_concat(MDB_FUNCTION_ARGS);
extern Datum tsvector_delete_str(MDB_FUNCTION_ARGS);
extern Datum tsvector_delete_arr(MDB_FUNCTION_ARGS);
extern Datum tsvector_unnest(MDB_FUNCTION_ARGS);
extern Datum tsvector_to_array(MDB_FUNCTION_ARGS);
extern Datum array_to_tsvector(MDB_FUNCTION_ARGS);
extern Datum tsvector_filter(MDB_FUNCTION_ARGS);
extern Datum tsvector_update_trigger_byid(MDB_FUNCTION_ARGS);
extern Datum tsvector_update_trigger_bycolumn(MDB_FUNCTION_ARGS);

extern Datum ts_match_vq(MDB_FUNCTION_ARGS);
extern Datum ts_match_qv(MDB_FUNCTION_ARGS);
extern Datum ts_match_tt(MDB_FUNCTION_ARGS);
extern Datum ts_match_tq(MDB_FUNCTION_ARGS);

extern Datum ts_stat1(MDB_FUNCTION_ARGS);
extern Datum ts_stat2(MDB_FUNCTION_ARGS);

extern Datum ts_rank_tt(MDB_FUNCTION_ARGS);
extern Datum ts_rank_wtt(MDB_FUNCTION_ARGS);
extern Datum ts_rank_ttf(MDB_FUNCTION_ARGS);
extern Datum ts_rank_wttf(MDB_FUNCTION_ARGS);
extern Datum ts_rankcd_tt(MDB_FUNCTION_ARGS);
extern Datum ts_rankcd_wtt(MDB_FUNCTION_ARGS);
extern Datum ts_rankcd_ttf(MDB_FUNCTION_ARGS);
extern Datum ts_rankcd_wttf(MDB_FUNCTION_ARGS);

extern Datum tsmatchsel(MDB_FUNCTION_ARGS);
extern Datum tsmatchjoinsel(MDB_FUNCTION_ARGS);

extern Datum ts_typanalyze(MDB_FUNCTION_ARGS);
...
typedef struct
{
	...
	int32		valcrc;			/* XXX: mdb_crc32 would be a more appropriate
 ...
 * but MDB_DETOAST_DATUM_COPY is used for simplicity
 */

#define DatumGetTSQuery(X)			((TSQuery) DatumGetPointer(X))
#define DatumGetTSQueryCopy(X)		((TSQuery) MDB_DETOAST_DATUM_COPY(X))
#define TSQueryGetDatum(X)			PointerGetDatum(X)
#define MDB_GETARG_TSQUERY(n)		DatumGetTSQuery(MDB_GETARG_DATUM(n))
#define MDB_GETARG_TSQUERY_COPY(n)	DatumGetTSQueryCopy(MDB_GETARG_DATUM(n))
#define MDB_RETURN_TSQUERY(x)		return TSQueryGetDatum(x)

/*
 * I/O
 */
extern Datum tsqueryin(MDB_FUNCTION_ARGS);
extern Datum tsqueryout(MDB_FUNCTION_ARGS);
extern Datum tsquerysend(MDB_FUNCTION_ARGS);
extern Datum tsqueryrecv(MDB_FUNCTION_ARGS);

/*
 * operations with tsquery
 */
extern Datum tsquery_lt(MDB_FUNCTION_ARGS);
extern Datum tsquery_le(MDB_FUNCTION_ARGS);
extern Datum tsquery_eq(MDB_FUNCTION_ARGS);
extern Datum tsquery_ne(MDB_FUNCTION_ARGS);
extern Datum tsquery_ge(MDB_FUNCTION_ARGS);
extern Datum tsquery_gt(MDB_FUNCTION_ARGS);
extern Datum tsquery_cmp(MDB_FUNCTION_ARGS);

extern Datum tsquerytree(MDB_FUNCTION_ARGS);
extern Datum tsquery_numnode(MDB_FUNCTION_ARGS);

extern Datum tsquery_and(MDB_FUNCTION_ARGS);
extern Datum tsquery_or(MDB_FUNCTION_ARGS);
extern Datum tsquery_phrase(MDB_FUNCTION_ARGS);
extern Datum tsquery_phrase_distance(MDB_FUNCTION_ARGS);
extern Datum tsquery_not(MDB_FUNCTION_ARGS);

extern Datum tsquery_rewrite(MDB_FUNCTION_ARGS);
extern Datum tsquery_rewrite_query(MDB_FUNCTION_ARGS);

extern Datum tsq_mcontains(MDB_FUNCTION_ARGS);
extern Datum tsq_mcontained(MDB_FUNCTION_ARGS);

#endif   /* _MDB_TSTYPE_H_ */
