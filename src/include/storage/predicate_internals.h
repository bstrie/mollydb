 ...
 */
#define InvalidSerCommitSeqNo		((SerCommitSeqNo) MDB_UINT64_MAX)
 ...
 * locks.  This is currently used only by the mdb_lock_status function,
 * which in turn is used by the mdb_locks view.
 */
