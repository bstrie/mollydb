...
extern Datum mdb_listening_channels(MDB_FUNCTION_ARGS);
extern Datum mdb_notify(MDB_FUNCTION_ARGS);
extern Datum mdb_notification_queue_usage(MDB_FUNCTION_ARGS);
