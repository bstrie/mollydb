 ...
 *
 * The core scanner is also used by PL/mdb, so we provide a public API
...
extern void scanner_yyerror(const char *message, core_yyscan_t yyscanner) mdb_attribute_noreturn();
