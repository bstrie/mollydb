...
extern Form_mdb_attribute attrtypes[MAXATTR];
extern int	numattr;


extern void AuxiliaryProcessMain(int argc, char *argv[]) mdb_attribute_noreturn();
...
extern void boot_yyerror(const char *str) mdb_attribute_noreturn();
