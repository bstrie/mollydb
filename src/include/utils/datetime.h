...
{
	mdb_tz	   *tz;				/* NULL if not yet looked up */
...
extern void GetCurrentDateTime(struct mdb_tm * tm);
extern void GetCurrentTimeUsec(struct mdb_tm * tm, fsec_t *fsec, int *tzp);
...
extern int DecodeDateTime(char **field, int *ftype,
			   int nf, int *dtype,
			   struct mdb_tm * tm, fsec_t *fsec, int *tzp);
...
extern void DateTimeParseError(int dterr, const char *str,
				   const char *datatype) mdb_attribute_noreturn();

extern int	DetermineTimeZoneOffset(struct mdb_tm * tm, mdb_tz *tzp);
extern int	DetermineTimeZoneAbbrevOffset(struct mdb_tm * tm, const char *abbr, mdb_tz *tzp);
extern int DetermineTimeZoneAbbrevOffsetTS(TimestampTz ts, const char *abbr,
								mdb_tz *tzp, int *isdst);

extern void EncodeDateOnly(struct mdb_tm * tm, int style, char *str);
extern void EncodeTimeOnly(struct mdb_tm * tm, fsec_t fsec, bool print_tz, int tz, int style, char *str);
extern void EncodeDateTime(struct mdb_tm * tm, fsec_t fsec, bool print_tz, int tz, const char *tzn, int style, char *str);
extern void EncodeInterval(struct mdb_tm * tm, fsec_t fsec, int style, char *str);
