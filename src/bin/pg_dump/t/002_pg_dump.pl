...
#		regexp => qr/^
#			\QSELECT mdb_catalog.lo_open\E \('\d+',\ \d+\);\n
#			\QSELECT mdb_catalog.lowrite(0, \E
#			\Q'\x310a320a330a340a350a360a370a380a390a');\E\n
#			\QSELECT mdb_catalog.lo_close(0);\E
#			/xm,
#		like => {
#			clean => 1,
#			clean_if_exists => 1,
...
#		},
#	},
	'COMMENT ON DATABASE mollydb' => {
		regexp => qr/^COMMENT ON DATABASE mollydb IS .*;/m,
		like => {
			binary_upgrade => 1,
			clean => 1,
			clean_if_exists => 1,
	...
	'CREATE DATABASE mollydb' => {
		regexp => qr/^
			\QCREATE DATABASE mollydb WITH TEMPLATE = template0 \E
			.*;/xm,
		like => {
			createdb => 1,
		},
	...
	'CREATE EXTENSION ... plmdb' => {
		regexp => qr/^
			\QCREATE EXTENSION IF NOT EXISTS plmdb WITH SCHEMA mdb_catalog;\E
			/xm,
		like => {
			clean => 1,
			clean_if_exists => 1,
	...
	'CREATE TYPE dump_test.planets AS ENUM mdb_upgrade' => {
		regexp => qr/^
			\QCREATE TYPE planets AS ENUM (\E
			\n\);.*^
...
#	},
	...
	'GRANT EXECUTE ON FUNCTION mdb_sleep() TO dump_test' => {
		create_order => 16,
		create_sql => 'GRANT EXECUTE ON FUNCTION mdb_sleep(float8)
						   TO dump_test;',
		regexp => qr/^
			\QGRANT ALL ON FUNCTION mdb_sleep(double precision) TO dump_test;\E
			/xm,
		like => {
			binary_upgrade => 1,
			clean => 1,
	...
	'GRANT SELECT (proname ...) ON TABLE mdb_proc TO public' => {
		create_order => 46,
		create_sql => 'GRANT SELECT (
						   ...
						   proconfig,
						   proacl
						) ON TABLE mdb_proc TO public;',
		regexp => qr/
		\QGRANT SELECT(tableoid) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(oid) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(proname) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(pronamespace) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(proowner) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(prolang) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(procost) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(prorows) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(provariadic) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(protransform) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(proisagg) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(proiswindow) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(prosecdef) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(proleakproof) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(proisstrict) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(proretset) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(provolatile) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(proparallel) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(pronargs) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(pronargdefaults) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(prorettype) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(proargtypes) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(proallargtypes) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(proargmodes) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(proargnames) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(proargdefaults) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(protrftypes) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(prosrc) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(probin) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(proconfig) ON TABLE mdb_proc TO PUBLIC;\E\n.*
		\QGRANT SELECT(proacl) ON TABLE mdb_proc TO PUBLIC;\E/xms,
		like => {
			binary_upgrade => 1,
			clean => 1,
			clean_if_exists => 1,
	...
	'REVOKE EXECUTE ON FUNCTION mdb_sleep() FROM public' => {
		create_order => 15,
		create_sql => 'REVOKE EXECUTE ON FUNCTION mdb_sleep(float8)
						   FROM public;',
		regexp => qr/^
			\QREVOKE ALL ON FUNCTION mdb_sleep(double precision) FROM PUBLIC;\E
			/xm,
		like => {
			binary_upgrade => 1,
			clean => 1,
	...
	'REVOKE SELECT ON TABLE mdb_proc FROM public' => {
		create_order => 45,
		create_sql => 'REVOKE SELECT ON TABLE mdb_proc FROM public;',
		regexp => qr/^REVOKE SELECT ON TABLE mdb_proc FROM PUBLIC;/m,
		like => {
			binary_upgrade => 1,
			clean => 1,
			clean_if_exists => 1,
...
command_exit_is([ 'mdb_dump', '-p', "$port", 'qqq' ],
	1, 'mdb_dump: [archiver (db)] connection to database "qqq" failed: FATAL:  database "qqq" does not exist');

command_exit_is([ 'mdb_dump', '-p', "$port", '--role=dump_test' ],
	1, 'mdb_dump: [archiver (db)] query failed: ERROR:  permission denied for');
