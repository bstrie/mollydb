...
-- CREATE FUNCTION
--
-- sanity check of mdb_proc catalog to the given parameters
--
...
CREATE FUNCTION functest_A_3() RETURNS bool LANGUAGE 'sql'
       AS 'SELECT false';
SELECT proname, prorettype::regtype, proargtypes::regtype[] FROM mdb_proc
...
SELECT proname, provolatile FROM mdb_proc
...
SELECT proname, prosecdef FROM mdb_proc
...
SELECT proname, proleakproof FROM mdb_proc
...
SELECT proname, proisstrict FROM mdb_proc
