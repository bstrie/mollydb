...
SELECT relreplident FROM mdb_class WHERE oid = 'test_replica_identity'::regclass;
-- but 'none' for system tables
SELECT relreplident FROM mdb_class WHERE oid = 'mdb_class'::regclass;
SELECT relreplident FROM mdb_class WHERE oid = 'mdb_constraint'::regclass;
...
SELECT relreplident FROM mdb_class WHERE oid = 'test_replica_identity'::regclass;
\d test_replica_identity
SELECT count(*) FROM mdb_index WHERE indrelid = 'test_replica_identity'::regclass AND indisreplident;
