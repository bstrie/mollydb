...
SELECT to_tsvector('synonym_tst', 'Postgresql is often called as mollydb or pgsql and pronounced as postgre');
...
SELECT to_tsvector('thesaurus_tst', 'one mollydb one two one two three one');
