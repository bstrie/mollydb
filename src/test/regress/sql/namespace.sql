...
SELECT COUNT(*) FROM mdb_class WHERE relnamespace =
    (SELECT oid FROM mdb_namespace WHERE nspname = 'test_schema_1');
...
SELECT COUNT(*) FROM mdb_class WHERE relnamespace =
    (SELECT oid FROM mdb_namespace WHERE nspname = 'test_schema_renamed');
