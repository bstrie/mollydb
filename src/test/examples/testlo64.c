...
static void
pickout(PGconn *conn, Oid lobjId, mdb_int64 start, int len)
{
	int			lobj_fd;
	char	   *buf;
	int			nbytes;
...
static void
overwrite(PGconn *conn, Oid lobjId, mdb_int64 start, int len)
{
	int			lobj_fd;
	char	   *buf;
	int			nbytes;
...
static void
my_truncate(PGconn *conn, Oid lobjId, mdb_int64 len)
{
	int			lobj_fd;
