...
main(void)
{
	...
	/* ECMDB_INFORMIX_ENOTDMY, need "dd", "mm" and "yy" */
	date_test_defmt("dmy", "20/11/1954");

	/* ECMDB_INFORMIX_ENOSHORTDATE */
	date_test_defmt("ddmmyy", "21254");
	date_test_defmt("ddmmyy", "    21254    ");

	/* ECMDB_INFORMIX_BAD_DAY */
	date_test_defmt("ddmmyy", "320494");

	/* ECMDB_INFORMIX_BAD_MONTH */
	date_test_defmt("mm-yyyy-dd", "13-1993-21");

	/* ECMDB_INFORMIX_BAD_YEAR */
	/* ??? */
...
check_return(int ret)
{
	switch(ret)
	{
		case ECMDB_INFORMIX_ENOTDMY:
			printf("(ECMDB_INFORMIX_ENOTDMY)");
			break;
		case ECMDB_INFORMIX_ENOSHORTDATE:
			printf("(ECMDB_INFORMIX_ENOSHORTDATE)");
			break;
		case ECMDB_INFORMIX_BAD_DAY:
			printf("(ECMDB_INFORMIX_BAD_DAY)");
			break;
		case ECMDB_INFORMIX_BAD_MONTH:
			printf("(ECMDB_INFORMIX_BAD_MONTH)");
			break;
		default:
