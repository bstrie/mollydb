...
static const struct cachedesc cacheinfo[] = {
	...
	{AccessMethodOperatorRelationId,	/* AMOPOPID */
		...
		3,
		{
			Anum_mdb_amop_amopopr,
			Anum_mdb_amop_amoppurpose,
			Anum_mdb_amop_amopfamily,
			0
		},
		64
	},
	{AccessMethodOperatorRelationId,	/* AMOPSTRATEGY */
		...
		{
			Anum_mdb_amop_amopfamily,
			Anum_mdb_amop_amoplefttype,
			Anum_mdb_amop_amoprighttype,
			Anum_mdb_amop_amopstrategy
		},
		64
	},
	{AccessMethodProcedureRelationId,	/* AMPROCNUM */
		...
		4,
		{
			Anum_mdb_amproc_amprocfamily,
			Anum_mdb_amproc_amproclefttype,
			Anum_mdb_amproc_amprocrighttype,
			Anum_mdb_amproc_amprocnum
		},
		16
	},
	...
	},
	{
		...
		2,
		{
			Anum_mdb_cast_castsource,
			Anum_mdb_cast_casttarget,
			0,
			0
		},
		256
	...
	{CollationRelationId,		/* COLLNAMEENCNSP */
		...
		3,
		{
			...
			Anum_mdb_collation_collencoding,
	...
	{ConversionRelationId,		/* CONDEFAULT */
		...
		4,
		{
			...
			Anum_mdb_conversion_conforencoding,
			Anum_mdb_conversion_contoencoding,
			ObjectIdAttributeNumber,
		},
		8
	},
	...
	{DefaultAclRelationId,		/* DEFACLROLENSPOBJ */
		...
		3,
		{
			Anum_mdb_default_acl_defaclrole,
			Anum_mdb_default_acl_defaclnamespace,
			Anum_mdb_default_acl_defaclobjtype,
			0
		},
		8
	},
	...
	{ForeignTableRelationId,	/* FOREIGNTABLEREL */
		...
		1,
		{
			Anum_mdb_foreign_table_ftrelid,
			0,
			0,
			0
		},
	...
	{OperatorRelationId,		/* OPERNAMENSP */
		...
		4,
		{
			...
			Anum_mdb_operator_oprleft,
			Anum_mdb_operator_oprright,
	...
	{ReplicationOriginRelationId,		/* REPLORIGNAME */
		...
		1,
		{
			Anum_mdb_replication_origin_roname,
			0,
			0,
			0
		},
	...
	{TransformRelationId,		/* TRFTYPELANG */
		...
		2,
		{
			Anum_mdb_transform_trftype,
			Anum_mdb_transform_trflang,
			0,
			0,
		},
		16
	...
	{TSConfigMapRelationId,		/* TSCONFIGMAP */
		...
		3,
		{
			...
			Anum_mdb_ts_config_map_mapseqno,
			0
		},
		2
	},
...
InitCatalogCache(void)
{
	...
	mdb_qsort(SysCacheRelationOid, SysCacheRelationOidSize,
	...
	mdb_qsort(SysCacheSupportingRelOid, SysCacheSupportingRelOidSize,
			 sizeof(Oid), oid_compare);
