 ...
 */
Datum
bpchar(MDB_FUNCTION_ARGS)
{
	BpChar	   *source = MDB_GETARG_BPCHAR_PP(0);
	int32		maxlen = MDB_GETARG_INT32(1);
 ...
 */
Datum
char_bpchar(MDB_FUNCTION_ARGS)
{
	char		c = MDB_GETARG_CHAR(0);
	BpChar	   *result;
 ...
 */
Datum
bpchar_name(MDB_FUNCTION_ARGS)
{
	BpChar	   *s = MDB_GETARG_BPCHAR_PP(0);
	char	   *s_data;
	Name		result;
	int			len;
...
Datum
bpchartypmodin(MDB_FUNCTION_ARGS)
{
	ArrayType  *ta = MDB_GETARG_ARRAYTYPE_P(0);

	MDB_RETURN_INT32(anychar_typmodin(ta, "char"));
}

Datum
bpchartypmodout(MDB_FUNCTION_ARGS)
{
	int32		typmod = MDB_GETARG_INT32(0);

	MDB_RETURN_CSTRING(anychar_typmodout(typmod));
}
 ...
 */
Datum
varchar_transform(MDB_FUNCTION_ARGS)
{
 ...
 */
Datum
varchar(MDB_FUNCTION_ARGS)
{
	VarChar    *source = MDB_GETARG_VARCHAR_PP(0);
	...
	MDB_RETURN_VARCHAR_P((VarChar *) cstring_to_text_with_len(s_data,
															 maxmblen));
}

Datum
varchartypmodin(MDB_FUNCTION_ARGS)
{
	ArrayType  *ta = MDB_GETARG_ARRAYTYPE_P(0);

	MDB_RETURN_INT32(anychar_typmodin(ta, "varchar"));
}

Datum
varchartypmodout(MDB_FUNCTION_ARGS)
{
	int32		typmod = MDB_GETARG_INT32(0);
...
Datum
bpcharlen(MDB_FUNCTION_ARGS)
{
	BpChar	   *arg = MDB_GETARG_BPCHAR_PP(0);
	int			len;
	...
	MDB_RETURN_INT32(len);
}

Datum
bpcharoctetlen(MDB_FUNCTION_ARGS)
{
	Datum		arg = MDB_GETARG_DATUM(0);

	/* We need not detoast the input at all */
	MDB_RETURN_INT32(toast_raw_datum_size(arg) - VARHDRSZ);
}
...
Datum
bpchareq(MDB_FUNCTION_ARGS)
{
	BpChar	   *arg1 = MDB_GETARG_BPCHAR_PP(0);
	BpChar	   *arg2 = MDB_GETARG_BPCHAR_PP(1);
	int			len1,
				len2;
	bool		result;
...
Datum
bpchar_sortsupport(MDB_FUNCTION_ARGS)
{
...
Datum
bpchar_larger(MDB_FUNCTION_ARGS)
{
	BpChar	   *arg1 = MDB_GETARG_BPCHAR_PP(0);
	BpChar	   *arg2 = MDB_GETARG_BPCHAR_PP(1);
	int			len1,
	...
	MDB_RETURN_BPCHAR_P((cmp >= 0) ? arg1 : arg2);
}

Datum
bpchar_smaller(MDB_FUNCTION_ARGS)
{
	BpChar	   *arg1 = MDB_GETARG_BPCHAR_PP(0);
	BpChar	   *arg2 = MDB_GETARG_BPCHAR_PP(1);
	int			len1,
 ...
 */
Datum
hashbpchar(MDB_FUNCTION_ARGS)
{
	BpChar	   *key = MDB_GETARG_BPCHAR_PP(0);
	char	   *keydata;
	int			keylen;
	Datum		result;
...
Datum
bpchar_pattern_lt(MDB_FUNCTION_ARGS)
{
	BpChar	   *arg1 = MDB_GETARG_BPCHAR_PP(0);
	BpChar	   *arg2 = MDB_GETARG_BPCHAR_PP(1);
	int			result;
...
Datum
bpchar_pattern_le(MDB_FUNCTION_ARGS)
{
	BpChar	   *arg1 = MDB_GETARG_BPCHAR_PP(0);
	BpChar	   *arg2 = MDB_GETARG_BPCHAR_PP(1);
	int			result;
...
Datum
bpchar_pattern_ge(MDB_FUNCTION_ARGS)
{
	BpChar	   *arg1 = MDB_GETARG_BPCHAR_PP(0);
	BpChar	   *arg2 = MDB_GETARG_BPCHAR_PP(1);
	int			result;
...
Datum
bpchar_pattern_gt(MDB_FUNCTION_ARGS)
{
	BpChar	   *arg1 = MDB_GETARG_BPCHAR_PP(0);
	BpChar	   *arg2 = MDB_GETARG_BPCHAR_PP(1);
	int			result;
...
Datum
btbpchar_pattern_cmp(MDB_FUNCTION_ARGS)
{
	BpChar	   *arg1 = MDB_GETARG_BPCHAR_PP(0);
	BpChar	   *arg2 = MDB_GETARG_BPCHAR_PP(1);
	int			result;
...
Datum
btbpchar_pattern_sortsupport(MDB_FUNCTION_ARGS)
{
	SortSupport ssup = (SortSupport) MDB_GETARG_POINTER(0);
	MemoryContext oldcontext;
