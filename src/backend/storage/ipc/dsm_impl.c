 ...
 * and which is always mapped at a fixed address in every MollyDB
 * background process.
 *
 ...
 * MollyDB) running on the same system.  Some systems only support
...
#define SEGMENT_NAME_PREFIX			"Global/MollyDB"
