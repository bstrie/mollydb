 ...
 * the set of keywords.  PL/mdb depends on this so that it can share the
 * same lexer.  If you add/change tokens here, fix PL/mdb to match!
 *
 * DOT_DOT is unused in the core SQL grammar, and so will always provoke
 * parse errors.  It is needed by PL/mdb.
 */
