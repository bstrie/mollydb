...
extern void PLy_elog(int elevel, const char *fmt,...) mdb_attribute_printf(2, 3);

extern void PLy_exception_set(PyObject *exc, const char *fmt,...) mdb_attribute_printf(2, 3);

extern void PLy_exception_set_plural(PyObject *exc, const char *fmt_singular, const char *fmt_plural,
	unsigned long n,...) mdb_attribute_printf(2, 5) mdb_attribute_printf(3, 5);
