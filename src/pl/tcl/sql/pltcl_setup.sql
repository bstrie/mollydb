...
create function check_primkey() returns trigger as E'
	...
	foreach key $keylist {
	    ...
	    #
	    # Lookup the fields type in mdb_attribute
	    #
	    set n [spi_exec "select T.typname			\\
	        from mdb_catalog.mdb_type T, mdb_catalog.mdb_attribute A, mdb_catalog.mdb_class C	\\
	...
	#
	spi_exec "select relname from mdb_catalog.mdb_class	\\
